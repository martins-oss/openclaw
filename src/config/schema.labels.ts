...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "session.rollover": "Session Proactive Rollover",
  "session.rollover.enabled": "Session Proactive Rollover Enabled",
  "session.rollover.maxTokens": "Session Rollover Max Tokens",
  "session.rollover.maxAgeMinutes": "Session Rollover Max Age Minutes",
  "session.rollover.maxMessages": "Session Rollover Max Messages",
